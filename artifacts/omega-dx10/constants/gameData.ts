...
export const CHARACTERS: Record<string, Character> = {
  agumon: {
    ...
    attribute: 'VC',
    element: 'FIRE',
    baseStats: { hp: 135, mp: 132, atk: 88, def: 73, spt: 60, spd: 66 },
  ...
  arestradamon: {
    ...
    attribute: 'DA',
    element: 'WIND',
    baseStats: { hp: 188, mp: 174, atk: 126, def: 108, spt: 102, spd: 114 },
  ...
  agumonSaver: {
    ...
    attribute: 'VC',
    element: 'FIRE',
    baseStats: { hp: 135, mp: 130, atk: 94, def: 76, spt: 66, spd: 69 },
  ...
  geoGreymon: {
    ...
    attribute: 'VC',
    element: 'FIRE',
    baseStats: { hp: 173, mp: 175, atk: 116, def: 98, spt: 71, spd: 80 },
  ...
  rizeGreymon: {
    ...
    attribute: 'VC',
    element: 'FIRE',
    baseStats: { hp: 220, mp: 247, atk: 138, def: 108, spt: 93, spd: 110 },
  ...
  shineGreymon: {
    ...
    attribute: 'VC',
    element: 'FIRE',
    baseStats: { hp: 323, mp: 330, atk: 173, def: 140, spt: 121, spd: 127 },
  ...
  gabumon: {
    ...
    attribute: 'DA',
    element: 'WATER',
    baseStats: { hp: 113, mp: 102, atk: 86, def: 59, spt: 53, spd: 63 },
  ...
  demiDevimon: {
    ...
    attribute: 'VR',
    element: 'DARK',
    baseStats: { hp: 100, mp: 118, atk: 75, def: 67, spt: 63, spd: 64 },
  ...
  guilmon: {
    ...
    attribute: 'VR',
    element: 'FIRE',
    baseStats: { hp: 120, mp: 101, atk: 87, def: 67, spt: 55, spd: 50 },
  ...
  growlmon: {
    ...
    attribute: 'VR',
    element: 'FIRE',
    baseStats: { hp: 175, mp: 161, atk: 117, def: 94, spt: 78, spd: 72 },
  ...
  megaloGrowlmon: {
    ...
    attribute: 'VR',
    element: 'FIRE',
    baseStats: { hp: 230, mp: 226, atk: 144, def: 124, spt: 98, spd: 92 },
  ...
  gallantmon: {
    ...
    attribute: 'VC',
    element: 'LIGHT',
    baseStats: { hp: 326, mp: 344, atk: 182, def: 165, spt: 165, spd: 137 },
  ...
  gallantmonCrimsonMode: {
    ...
    attribute: 'VC',
    element: 'LIGHT',
    baseStats: { hp: 336, mp: 370, atk: 190, def: 170, spt: 168, spd: 143 },
  ...
  lucemon: {
    ...
    attribute: 'VC',
    element: 'LIGHT',
    baseStats: { hp: 112, mp: 116, atk: 79, def: 69, spt: 78, spd: 72 },
  ...
  lucemonChaosMode: {
    ...
    attribute: 'VR',
    element: 'DARK',
    baseStats: { hp: 243, mp: 265, atk: 142, def: 113, spt: 119, spd: 118 },
  ...
  lucemonSatanMode: {
    ...
    attribute: 'VR',
    element: 'DARK',
    baseStats: { hp: 250, mp: 265, atk: 135, def: 113, spt: 110, spd: 110 },
  ...
  lucemonX: {
    ...
    attribute: 'VR',
    element: 'DARK',
    baseStats: { hp: 255, mp: 270, atk: 148, def: 118, spt: 125, spd: 122 },
  ...
  magnadramon: {
    ...
    attribute: 'VC',
    element: 'WIND',
    baseStats: { hp: 261, mp: 296, atk: 139, def: 134, spt: 149, spd: 131 },
  ...
  ophanimon: {
    ...
    attribute: 'VC',
    element: 'LIGHT',
    baseStats: { hp: 233, mp: 275, atk: 131, def: 124, spt: 141, spd: 125 },
  ...
  angewomon: {
    ...
    attribute: 'VC',
    element: 'LIGHT',
    baseStats: { hp: 215, mp: 237, atk: 127, def: 99, spt: 117, spd: 114 },
  ...
  tailmon: {
    ...
    attribute: 'VC',
    element: 'LIGHT',
    baseStats: { hp: 138, mp: 151, atk: 95, def: 77, spt: 86, spd: 89 },
  ...
  salamon: {
    ...
    attribute: 'VC',
    element: 'LIGHT',
    baseStats: { hp: 105, mp: 119, atk: 76, def: 59, spt: 64, spd: 61 },
  ...
  phoenixmon: {
    ...
    attribute: 'VC',
    element: 'WIND',
    baseStats: { hp: 325, mp: 352, atk: 171, def: 141, spt: 167, spd: 141 },
  ...
  garudamon: {
    ...
    attribute: 'VC',
    element: 'WIND',
    baseStats: { hp: 215, mp: 250, atk: 128, def: 99, spt: 116, spd: 115 },
  ...
  birdramon: {
    ...
    attribute: 'VC',
    element: 'WIND',
    baseStats: { hp: 149, mp: 168, atk: 92, def: 75, spt: 88, spd: 90 },
  ...
  pyomon: {
    ...
    attribute: 'VC',
    element: 'WIND',
    baseStats: { hp: 101, mp: 114, atk: 72, def: 61, spt: 66, spd: 79 },
  ...
  patamon: {
    ...
    attribute: 'DA',
    element: 'WIND',
    baseStats: { hp: 121, mp: 114, atk: 68, def: 54, spt: 58, spd: 55 },
  ...
  angemon: {
    ...
    attribute: 'VC',
    element: 'LIGHT',
    baseStats: { hp: 168, mp: 191, atk: 96, def: 79, spt: 89, spd: 78 },
  ...
  magnaAngemon: {
    ...
    attribute: 'VC',
    element: 'LIGHT',
    baseStats: { hp: 234, mp: 264, atk: 128, def: 112, spt: 123, spd: 102 },
  ...
  goldramon: {
    ...
    attribute: 'VC',
    element: 'LIGHT',
    baseStats: { hp: 333, mp: 349, atk: 182, def: 151, spt: 168, spd: 138 },
  ...
  seraphimon: {
    ...
    attribute: 'VC',
    element: 'LIGHT',
    baseStats: { hp: 308, mp: 366, atk: 178, def: 148, spt: 177, spd: 137 },
  ...
  devimon: {
    ...
    attribute: 'VR',
    element: 'DARK',
    baseStats: { hp: 166, mp: 170, atk: 108, def: 82, spt: 92, spd: 79 },
  ...
  myotismon: {
    ...
    attribute: 'VR',
    element: 'DARK',
    baseStats: { hp: 233, mp: 260, atk: 132, def: 121, spt: 119, spd: 95 },
  ...
  vnonMyotismon: {
    ...
    attribute: 'VR',
    element: 'DARK',
    baseStats: { hp: 322, mp: 345, atk: 231, def: 182, spt: 186, spd: 163 },
  ...
  garurumon: {
    ...
    attribute: 'DA',
    element: 'ICE',
    baseStats: { hp: 144, mp: 107, atk: 91, def: 80, spt: 53, spd: 61 },
  ...
  wereGarurumon: {
    ...
    attribute: 'DA',
    element: 'ICE',
    baseStats: { hp: 200, mp: 220, atk: 130, def: 115, spt: 80, spd: 100 },
  ...
  metalGarurumon: {
    ...
    attribute: 'DA',
    element: 'ICE',
    baseStats: { hp: 312, mp: 338, atk: 167, def: 121, spt: 124, spd: 131 },
  ...
  omegamon: {
    ...
    attribute: 'VC',
    element: 'LIGHT',
    baseStats: { hp: 334, mp: 358, atk: 185, def: 143, spt: 170, spd: 143 },
  ...
  shineGreymonBurstMode: {
    ...
    attribute: 'VC',
    element: 'FIRE',
    baseStats: { hp: 332, mp: 350, atk: 187, def: 160, spt: 162, spd: 142 },
  ...
  veemon: {
    ...
    attribute: 'FR',
    element: 'FIRE',
    baseStats: { hp: 116, mp: 104, atk: 81, def: 63, spt: 52, spd: 60 },
  ...
  exVeemon: {
    ...
    attribute: 'FR',
    element: 'FIRE',
    baseStats: { hp: 204, mp: 178, atk: 131, def: 97, spt: 85, spd: 105 },
  ...
  paildramon: {
    ...
    attribute: 'DA',
    element: 'FIRE',
    baseStats: { hp: 264, mp: 271, atk: 168, def: 121, spt: 108, spd: 141 },
  ...
  imperialDramonFM: {
    ...
    attribute: 'VC',
    element: 'FIRE',
    baseStats: { hp: 320, mp: 340, atk: 174, def: 142, spt: 120, spd: 128 },
  ...
  imperialDramonRM: {
    ...
    attribute: 'VC',
    element: 'FIRE',
    baseStats: { hp: 315, mp: 342, atk: 173, def: 141, spt: 111, spd: 127 },
  ...
  imperialDramonPM: {
    ...
    attribute: 'VC',
    element: 'LIGHT',
    baseStats: { hp: 341, mp: 366, atk: 188, def: 150, spt: 166, spd: 145 },
  ...
  blackImperialdramonFM: {
    ...
    attribute: 'VC',
    element: 'DARK',
    baseStats: { hp: 330, mp: 355, atk: 185, def: 148, spt: 130, spd: 140 },
  ...
  rosemon: {
    ...
    attribute: 'DA',
    element: 'PLANT',
    baseStats: { hp: 251, mp: 288, atk: 139, def: 117, spt: 132, spd: 121 },
  ...
  rosemonBurstMode: {
    ...
    attribute: 'DA',
    element: 'PLANT',
    baseStats: { hp: 318, mp: 378, atk: 161, def: 135, spt: 158, spd: 142 },
  ...
  lillymon: {
    ...
    attribute: 'DA',
    element: 'PLANT',
    baseStats: { hp: 209, mp: 244, atk: 112, def: 108, spt: 118, spd: 114 },
  ...
  togemon: {
    ...
    attribute: 'DA',
    element: 'PLANT',
    baseStats: { hp: 166, mp: 166, atk: 108, def: 96, spt: 67, spd: 71 },
  ...
  palmon: {
    ...
    attribute: 'DA',
    element: 'PLANT',
    baseStats: { hp: 103, mp: 114, atk: 74, def: 57, spt: 55, spd: 61 },
  ...
  gulusGammamon: {
    ...
    attribute: 'VR',
    element: 'DARK',
    baseStats: { hp: 290, mp: 260, atk: 230, def: 170, spt: 150, spd: 210 },
  ...
  greymon: {
    ...
    attribute: 'VC',
    element: 'FIRE',
    baseStats: { hp: 170, mp: 165, atk: 115, def: 92, spt: 72, spd: 80 },
  ...
  metalGreymon: {
    ...
    attribute: 'VC',
    element: 'FIRE',
    baseStats: { hp: 215, mp: 210, atk: 137, def: 117, spt: 94, spd: 100 },
  ...
  warGreymon: {
    ...
    attribute: 'VC',
    element: 'FIRE',
    baseStats: { hp: 320, mp: 335, atk: 171, def: 146, spt: 126, spd: 122 },
  ...
  silphymon: {
    ...
    attribute: 'DA',
    element: 'WIND',
    baseStats: { hp: 290, mp: 310, atk: 160, def: 135, spt: 155, spd: 165 },
  ...
  sinduramon: {
    ...
    attribute: 'VC',
    element: 'LIGHTNING',
    baseStats: { hp: 205, mp: 215, atk: 125, def: 105, spt: 115, spd: 110 },
  ...
  valdurmon: {
    ...
    attribute: 'VC',
    element: 'LIGHT',
    baseStats: { hp: 326, mp: 352, atk: 178, def: 146, spt: 175, spd: 143 },
  ...
  blackSalamon: {
    ...
    attribute: 'VR',
    element: 'DARK',
    baseStats: { hp: 110, mp: 105, atk: 78, def: 65, spt: 72, spd: 60 },
  ...
  mushroomon: {
    ...
    attribute: 'VR',
    element: 'PLANT',
    baseStats: { hp: 105, mp: 115, atk: 72, def: 62, spt: 75, spd: 58 },
  ...
  tentomon: {
    ...
    attribute: 'DA',
    element: 'LIGHTNING',
    baseStats: { hp: 118, mp: 125, atk: 82, def: 68, spt: 80, spd: 64 },
  ...
  renamon: {
    ...
    attribute: 'DA',
    element: 'WIND',
    baseStats: { hp: 108, mp: 120, atk: 92, def: 58, spt: 78, spd: 82 },
  ...
  terriermon: {
    ...
    attribute: 'VC',
    element: 'WIND',
    baseStats: { hp: 115, mp: 118, atk: 84, def: 70, spt: 68, spd: 76 },
  ...
  wormon: {
    ...
    attribute: 'VR',
    element: 'PLANT',
    baseStats: { hp: 100, mp: 112, atk: 70, def: 60, spt: 65, spd: 55 },
  ...
  kumamon: {
    ...
    attribute: 'VC',
    element: 'ICE',
    baseStats: { hp: 122, mp: 110, atk: 80, def: 72, spt: 66, spd: 68 },
  ...
  woodmon: {
    ...
    attribute: 'VR',
    element: 'PLANT',
    baseStats: { hp: 168, mp: 162, atk: 112, def: 90, spt: 85, spd: 72 },
  ...
  gomamon: {
    ...
    attribute: 'VC',
    element: 'WATER',
    baseStats: { hp: 112, mp: 108, atk: 78, def: 65, spt: 62, spd: 70 },
  ...
  kokwamon: {
    ...
    attribute: 'DA',
    element: 'LIGHTNING',
    baseStats: { hp: 106, mp: 130, atk: 74, def: 60, spt: 85, spd: 58 },
  ...
  lalamon: {
    ...
    attribute: 'DA',
    element: 'PLANT',
    baseStats: { hp: 105, mp: 122, atk: 72, def: 62, spt: 82, spd: 60 },
  ...
  gaomon: {
    ...
    attribute: 'DA',
    element: 'WIND',
    baseStats: { hp: 120, mp: 108, atk: 88, def: 72, spt: 60, spd: 75 },
  ...
  kotemon: {
    ...
    attribute: 'DA',
    element: 'FIRE',
    baseStats: { hp: 115, mp: 105, atk: 85, def: 78, spt: 58, spd: 62 },
  ...
  otamamon: {
    ...
    attribute: 'VR',
    element: 'WATER',
    baseStats: { hp: 108, mp: 118, atk: 72, def: 64, spt: 75, spd: 58 },
  ...
  betamon: {
    ...
    attribute: 'VR',
    element: 'WATER',
    baseStats: { hp: 118, mp: 112, atk: 80, def: 68, spt: 65, spd: 60 },
  ...
  candlemon: {
    ...
    attribute: 'DA',
    element: 'FIRE',
    baseStats: { hp: 108, mp: 122, atk: 78, def: 60, spt: 85, spd: 56 },
  ...
  falcomon: {
    ...
    attribute: 'VC',
    element: 'WIND',
    baseStats: { hp: 112, mp: 105, atk: 82, def: 64, spt: 62, spd: 88 },
  ...
  hagurumon: {
    ...
    attribute: 'VR',
    element: 'METAL',
    baseStats: { hp: 115, mp: 112, atk: 76, def: 80, spt: 68, spd: 52 },
  ...
  kamemon: {
    ...
    attribute: 'VC',
    element: 'WATER',
    baseStats: { hp: 118, mp: 108, atk: 74, def: 80, spt: 62, spd: 56 },
  ...
  monodramon: {
    ...
    attribute: 'VR',
    element: 'EARTH',
    baseStats: { hp: 120, mp: 108, atk: 86, def: 70, spt: 64, spd: 68 },
  ...
  penguinmon: {
    ...
    attribute: 'DA',
    element: 'ICE',
    baseStats: { hp: 112, mp: 110, atk: 74, def: 68, spt: 65, spd: 75 },
  ...
  pipismon: {
    ...
    attribute: 'FR',
    element: 'WIND',
    baseStats: { hp: 172, mp: 168, atk: 110, def: 88, spt: 90, spd: 95 },
  ...
  guardromon: {
    ...
    attribute: 'DA',
    element: 'METAL',
    baseStats: { hp: 178, mp: 158, atk: 115, def: 105, spt: 82, spd: 68 },
  ...
  solarmon: {
    ...
    attribute: 'VC',
    element: 'FIRE',
    baseStats: { hp: 108, mp: 112, atk: 76, def: 68, spt: 72, spd: 60 },
  ...
  toyagumon: {
    ...
    attribute: 'VC',
    element: 'FIRE',
    baseStats: { hp: 115, mp: 105, atk: 80, def: 72, spt: 58, spd: 64 },
  ...
  piddomon: {
    ...
    attribute: 'VC',
    element: 'LIGHT',
    baseStats: { hp: 170, mp: 175, atk: 112, def: 90, spt: 105, spd: 80 },
  ...
  reppamon: {
    ...
    attribute: 'VC',
    element: 'WIND',
    baseStats: { hp: 175, mp: 165, atk: 118, def: 92, spt: 88, spd: 95 },
  ...
  stingmon: {
    ...
    attribute: 'VR',
    element: 'PLANT',
    baseStats: { hp: 172, mp: 168, atk: 122, def: 88, spt: 90, spd: 92 },
  ...
  aquilamon: {
    ...
    attribute: 'DA',
    element: 'WIND',
    baseStats: { hp: 175, mp: 162, atk: 118, def: 90, spt: 85, spd: 95 },
  ...
  ogremon: {
    ...
    attribute: 'VR',
    element: 'DARK',
    baseStats: { hp: 180, mp: 152, atk: 125, def: 95, spt: 80, spd: 85 },
  ...
  airdramon: {
    ...
    attribute: 'VC',
    element: 'WIND',
    baseStats: { hp: 168, mp: 168, atk: 112, def: 85, spt: 92, spd: 98 },
  ...
  tyranomon: {
    ...
    attribute: 'VR',
    element: 'FIRE',
    baseStats: { hp: 182, mp: 155, atk: 120, def: 98, spt: 78, spd: 75 },
  ...
  seadramon: {
    ...
    attribute: 'DA',
    element: 'WATER',
    baseStats: { hp: 175, mp: 165, atk: 115, def: 92, spt: 85, spd: 88 },
  ...
  allomon: {
    ...
    attribute: 'DA',
    element: 'FIRE',
    baseStats: { hp: 178, mp: 155, atk: 122, def: 96, spt: 80, spd: 78 },
  ...
  darktyranomon: {
    ...
    attribute: 'VR',
    element: 'DARK',
    baseStats: { hp: 185, mp: 158, atk: 128, def: 102, spt: 82, spd: 78 },
  ...
  blacktailmon: {
    ...
    attribute: 'VR',
    element: 'DARK',
    baseStats: { hp: 172, mp: 168, atk: 115, def: 90, spt: 100, spd: 88 },
  ...
  darklizardmon: {
    ...
    attribute: 'VR',
    element: 'DARK',
    baseStats: { hp: 175, mp: 162, atk: 118, def: 92, spt: 85, spd: 82 },
  ...
  devidramon: {
    ...
    attribute: 'VR',
    element: 'DARK',
    baseStats: { hp: 178, mp: 162, atk: 122, def: 92, spt: 88, spd: 85 },
  ...
  tiranomon: {
    ...
    attribute: 'VR',
    element: 'FIRE',
    baseStats: { hp: 168, mp: 155, atk: 122, def: 85, spt: 68, spd: 92 },
  ...
  skullgreymon: {
    ...
    attribute: 'VR',
    element: 'DARK',
    baseStats: { hp: 248, mp: 225, atk: 152, def: 118, spt: 95, spd: 110 },
...
export const TAMERS: TamerOption[] = [
  // Female tamers
  {
    ...
    accentColor: '#22c55e',
    image: require('../assets/tamers/mimi_bg.webp'),
    forGender: 'F',
    avatarOffset: -8,
    avatarOffsetX: 0,
  },
  {
    ...
    accentColor: '#ef4444',
    image: require('../assets/tamers/sora_bg.webp'),
    forGender: 'F',
    avatarOffset: -8,
    avatarOffsetX: 0,
  },
  {
    ...
    accentColor: '#ec4899',
    image: require('../assets/tamers/kari_bg.webp'),
    forGender: 'F',
    avatarOffset: -8,
    avatarOffsetX: -2,
  },
  // Male tamers
  {
    ...
    accentColor: '#3b82f6',
    image: require('../assets/tamers/matt.webp'),
    forGender: 'M',
    avatarOffset: -8,
    avatarOffsetX: 0,
  },
  {
    ...
    accentColor: '#f97316',
    image: require('../assets/tamers/tai_bg.webp'),
    forGender: 'M',
    avatarOffset: -8,
    avatarOffsetX: 0,
  },
  {
    ...
    accentColor: '#eab308',
    image: require('../assets/tamers/tk.webp'),
    forGender: 'M',
    avatarOffset: -23,
    avatarOffsetX: 0,
  },
